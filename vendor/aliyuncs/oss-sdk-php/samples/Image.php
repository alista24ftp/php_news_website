...
$options = array(
    ...
    OssClient::OSS_PROCESS => "images/resize,m_fixed,h_100,w_100", );
...
$options = array(
    OssClient::OSS_FILE_DOWNLOAD => $download_file,
    OssClient::OSS_PROCESS => "images/crop,w_100,h_100,x_100,y_100,r_1", );
$ossClient->getObject($bucketName, $object, $options);
...
$options = array(
    OssClient::OSS_FILE_DOWNLOAD => $download_file,
    OssClient::OSS_PROCESS => "images/rotate,90", );
$ossClient->getObject($bucketName, $object, $options);
...
$options = array(
    OssClient::OSS_FILE_DOWNLOAD => $download_file,
    OssClient::OSS_PROCESS => "images/sharpen,100", );
$ossClient->getObject($bucketName, $object, $options);
...
$options = array(
    OssClient::OSS_FILE_DOWNLOAD => $download_file,
    OssClient::OSS_PROCESS => "images/watermark,text_SGVsbG8g5Zu-54mH5pyN5YqhIQ", );
$ossClient->getObject($bucketName, $object, $options);
...
$options = array(
    OssClient::OSS_FILE_DOWNLOAD => $download_file,
    OssClient::OSS_PROCESS => "images/format,png", );
$ossClient->getObject($bucketName, $object, $options);
...
$options = array(
    OssClient::OSS_FILE_DOWNLOAD => $download_file,
    OssClient::OSS_PROCESS => "images/info", );
$ossClient->getObject($bucketName, $object, $options);
 ...
 */
 $timeout = 3600;
$options = array(
    OssClient::OSS_PROCESS => "images/resize,m_lfit,h_100,w_100",
    );
...
function printImage($func, $imageFile)
{
    ...
    Common::println("$func, images width: " . $array[0]);
    Common::println("$func, images height: " . $array[1]);
    Common::println("$func, images type: " . ($array[2] === 2 ? 'jpg' : 'png'));
    Common::println("$func, images size: " . ceil(filesize($imageFile)));
}
