...
class InfoTest extends TestCase
{
    ...
    {
        $this->setExpectedException("\\think\\images\\Exception");
        Image::open('');
    }

    public function testIllegal()
    {
        $this->setExpectedException("\\think\\images\\Exception", 'Illegal images file');
    ...
    public function testJpeg()
    {
        ...
        $this->assertEquals('images/jpeg', $image->mime());
    ...
    public function testPng()
    {
        ...
        $this->assertEquals('images/png', $image->mime());
        $this->assertEquals([800, 600], $image->size());
    }
    ...
    public function testGif()
    {
        ...
        $this->assertEquals('images/gif', $image->mime());
