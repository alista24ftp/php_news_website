...
class News extends Base
{
    ...
    public function index()
    {
        ...
        $newsModel = new N;
        $newsAllToutiao = $newsModel->getAllToutiao('n_id,news_title');
        $newsAllRecom = $newsModel->getRand(4,
        ...
        $newsRecom = $newsModel->getRand(10,
            ...
            'news_time',
            100,
            $news['news_columnviceid'],
            'c');
        $newsHot = $newsModel->getRand(10,
            'n_id,news_title,news_img',
            'news_hits',
            100,
            $news['news_columnviceid'],
            null);
        $newsOtherList = $newsModel->getOtherLists($news['news_columnviceid']);

        $this->assign("t_open",$t_open);
        $this->assign($news);
        $this->assign('toutiaos', $newsAllToutiao);
        $this->assign('news_all_recom', $newsAllRecom);
        $this->assign('news_recom', $newsRecom);
        $this->assign('news_hot', $newsHot);
        $this->assign('news_other_list', $newsOtherList);
		$this->assign('menu',$menu);
		$this->assign('list_id',$news['news_columnid']);
