...
class Yf extends Taglib
{
    ...
    protected $tags = [
        ...
        'news' => ['attr' => 'name,ids,cid,cvid,field,limit,order,where,ispage,pagesize,type,key', 'close' => 0],
    ...
    public function tagMenu($tag)
    {
		...
		$parenttpl='<a href=\'#\'  data-toggle=\"dropdown\" data-hover=\"dropdown\" aria-expanded=\"false\" class=\''.$haschild_a_class.'\'>\$menu_name<span class=\''.$haschild_span_class.'\'>&nbsp;<i class=\'fa fa-angle-down\'></i></span></a>';
		$parseStr = '<?php ';
